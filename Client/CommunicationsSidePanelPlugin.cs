...
namespace Communications.Client
{
	...
	/// </summary>
	public class CommunicationsSidePanelPlugin : SidePanelPlugin
	{
		private CommunicationsSmartClientBackgroundPlugin _smartClientBackgroundPlugin;
		public CommunicationsSidePanelPlugin(CommunicationsSmartClientBackgroundPlugin smartClientBackgroundPlugin) 
		{
		...
		{
			return new CommunicationsSidePanelUserControl(_smartClientBackgroundPlugin);
		}
		...
		{
			get { return CommunicationsDefinition.CommunicationsSidePanelId; }
		}
		...
		{
			get { return "Communications Side panel"; }
		}
